var chart = {
    ...
    plotOptions: { bar: { horizontal: !1, barHeight: "80%", columnWidth: "20%", borderRadius: [3] } },
    ...
    options =
        ((chart = new ApexCharts(document.querySelector("#reports"), chart)).render(),
        {
            series: [76],
    ...
    options =
        ((chart = new ApexCharts(document.querySelector("#cashflow"), options)).render(),
        {
